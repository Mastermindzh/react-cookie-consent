import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{C as a,d as c,I as l}from"./intro-Cm30TdeZ.js";import"./index-CgHwlBRe.js";const d={title:"CookieConsent/Accept On Scroll",component:a,parameters:{controls:{expanded:!0}}},r={args:{...c,onAccept:t=>{alert(`ACCEPTED! By scrolling? ${JSON.stringify(t)}`)},acceptOnScroll:!0,acceptOnScrollPercentage:25,children:"Scroll for 25% and the onAccept will trigger"},render:t=>e.jsxs(e.Fragment,{children:[e.jsx(l,{}),Array.from(new Array(25).keys()).map(s=>e.jsx("p",{children:"Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptates ipsa sequi soluta mollitia illum, hic quaerat ipsum sint odit delectus magni neque sunt adipisci culpa harum aut distinctio quisquam ab!"},s)),e.jsx(a,{...t})]})};var n,i,o;r.parameters={...r.parameters,docs:{...(n=r.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    ...defaultStoryProps,
